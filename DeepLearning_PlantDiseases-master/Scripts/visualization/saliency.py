...
parser.add_argument('model_path', metavar='N', help='path to trained model',default='')
parser.add_argument('data_dir', metavar='DIR', help='path to output dir',default='')
parser.add_argument('image_path',metavar='N', help='path to the image',default='')
parser.add_argument('image_class',metavar='N', help='disease name',default='')
...
def load_labels(data_dir,resize=(224,224)):
    ...
    dsets = {x: datasets.ImageFolder(os.path.join(data_dir, 'trainingset'), data_transforms[x])
             for x in ['trainingset']}
    return (dsets['trainingset'].classes)
